      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="16" class="row-spacing">
        <el-card style="padding: 20px">
          ...
          <div style="height: 600px; width: 100%">
            <component
              :is="chartComponent('fiveLineAndOneBar')"
              :data="items"
...
import { getAnalyze1 } from "@/api/index.ts"
import { colorList } from "@/utils/chartColor.ts"
import TableFiveData from "@/components/TableFiveData/index.vue"
